...
This means when configuring these attributes you need to pass in the configuration as objects and with snake case keys. Alternatively you can also use the [escape hatch](https://developer.hashicorp.com/terraform/cdktf/concepts/resources#escape-hatch).
